...
if (!empty($searchJieBie)) {
    $whereClause.= " AND RXN LIKE '%". mysql_real_escape_string($searchJieBie, $login). "%'";
}
if (!empty($searchXingMing)) {
    $whereClause.= " AND cj.XM LIKE '%". mysql_real_escape_string($searchXingMing, $login). "%'";
}
